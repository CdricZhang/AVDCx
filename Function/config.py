...
def update_config(json_config) -> dict:
    ...
    if json_config['type'] == 'http':
        json_config['proxies'] = {
            "http": "http://" + json_config['proxy'], "https": "http://" + json_config['proxy']}
    elif json_config['type'] == 'socks5':
        json_config['proxies'] = {
            "http": "socks5h://" + json_config['proxy'], "https": "socks5h://" + json_config['proxy']}
    else:
    ...
    # 获取网址
    json_config['javbus_website'] = json_config['javbus_website'].replace(
        'https://', '').replace('http://', '').strip('/')
    json_config['javdb_website'] = json_config['javdb_website'].replace(
        'https://', '').replace('http://', '').strip('/')
...
def save_config(json_config):
    ...
    with open(config_file, "wt", encoding='UTF-8') as code:
        ...
        print("modified_time = " +
              time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), file=code)
        print("", file=code)
        print("[common]", file=code)
        print("main_mode = " + str(json_config['main_mode']), file=code)
        print("no_nfo_scrape = " +
              str(json_config['no_nfo_scrape']), file=code)
        print("main_like = " + str(json_config['main_like']), file=code)
        print("more_website = " + str(json_config['more_website']), file=code)
        print("success_file_move = " +
              str(json_config['success_file_move']), file=code)
        print("failed_file_move = " +
              str(json_config['failed_file_move']), file=code)
        print("success_file_rename = " +
              str(json_config['success_file_rename']), file=code)
        print("del_empty_folder = " +
              str(json_config['del_empty_folder']), file=code)
        ...
        print("translate_language = " +
              str(json_config['translate_language']), file=code)
        print("translate_content = " +
              str(json_config['translate_content']), file=code)
        ...
        print("series_as_set = " +
              str(json_config['series_as_set']), file=code)
        ...
        print("javbus_website = " +
              str(json_config['javbus_website']), file=code)
        print("javdb_website = " +
              str(json_config['javdb_website']), file=code)
        ...
        print("folder_name_max = " +
              str(json_config['folder_name_max']), file=code)
        print("file_name_max = " +
              str(json_config['file_name_max']), file=code)
        print("actor_name_max = " +
              str(json_config['actor_name_max']), file=code)
        print("actor_name_more = " +
              str(json_config['actor_name_more']), file=code)
        print("actor_no_name = " +
              str(json_config['actor_no_name']), file=code)
        ...
        print("folder_cnword = " +
              str(json_config['folder_cnword']), file=code)
        print("file_cnword = " + str(json_config['file_cnword']), file=code)
        print("del_actor_name = " +
              str(json_config['del_actor_name']), file=code)
        ...
        print("success_output_folder = " +
              str(json_config['success_output_folder']), file=code)
        print("failed_output_folder = " +
              str(json_config['failed_output_folder']), file=code)
        print("extrafanart_folder = " +
              str(json_config['extrafanart_folder']), file=code)
        ...
        print("actor_photo_folder = " +
              str(json_config['actor_photo_folder']), file=code)
        print("actor_photo_upload = " +
              str(json_config['actor_photo_upload']), file=code)
        print("", file=code)
        ...
        print("download_poster = " +
              str(json_config['download_poster']), file=code)
        print("download_thumb = " +
              str(json_config['download_thumb']), file=code)
        print("download_fanart = " +
              str(json_config['download_fanart']), file=code)
        print("download_extrafanart = " +
              str(json_config['download_extrafanart']), file=code)
        print("download_extrafanart_copy = " +
              str(json_config['download_extrafanart_copy']), file=code)
        print("keep_local_nfo = " +
              str(json_config['keep_local_nfo']), file=code)
        print("keep_local_poster = " +
              str(json_config['keep_local_poster']), file=code)
        print("keep_local_thumb = " +
              str(json_config['keep_local_thumb']), file=code)
        print("keep_local_fanart = " +
              str(json_config['keep_local_fanart']), file=code)
        print("keep_local_extrafanart = " +
              str(json_config['keep_local_extrafanart']), file=code)
        print("keep_local_extrafanart_copy = " +
              str(json_config['keep_local_extrafanart_copy']), file=code)
