...
################################################################################
## Form generated from reading UI file 'posterCutToolLeJSUB.ui'
##
...
class Ui_Dialog_cut_poster(object):
    def setupUi(self, Dialog_cut_poster):
        ...
        self.checkBox_add_sub = QCheckBox(self.widget)
        self.checkBox_add_sub.setObjectName(u"checkBox_add_sub")
        self.checkBox_add_sub.setGeometry(QRect(20, 320, 51, 20))
        self.label_2 = QLabel(self.widget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(20, 290, 131, 16))
        font = QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_2.setFont(font)
        self.checkBox_add_uncensored = QCheckBox(self.widget)
        self.checkBox_add_uncensored.setObjectName(u"checkBox_add_uncensored")
        self.checkBox_add_uncensored.setGeometry(QRect(140, 320, 51, 20))
        self.checkBox_add_leak = QCheckBox(self.widget)
        self.checkBox_add_leak.setObjectName(u"checkBox_add_leak")
        self.checkBox_add_leak.setGeometry(QRect(80, 320, 51, 20))
    ...
    def retranslateUi(self, Dialog_cut_poster):
        Dialog_cut_poster.setWindowTitle(QCoreApplication.translate("Dialog_cut_poster", u"\u5c01\u9762\u56fe\u7247\u88c1\u526a", None))
        ...
        self.checkBox_add_uncensored.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u65e0\u7801", None))
        self.checkBox_add_leak.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u6d41\u51fa", None))
        self.pushButton_open_pic.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u6253\u5f00\u56fe\u7247", None))
        ...
        self.label_cut_postion.setText(QCoreApplication.translate("Dialog_cut_poster", u"400\uff0c0\uff0c379\uff0c538", None))
        ...
        self.pushButton_cut_close.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u88c1\u526a\u5e76\u5173\u95ed", None))
        ...
        self.pushButton_to_cut_2.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u786e\u5b9a\u88c1\u526a", None))
        self.label_4.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u88c1\u526a\u6846\u5de6/\u4e0a\u4f4d\u7f6e", None))
        self.label_6.setText(QCoreApplication.translate("Dialog_cut_poster", u"\u88c1\u526a\u6846\u53f3/\u4e0b\u4f4d\u7f6e", None))
    # retranslateUi
